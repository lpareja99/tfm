...
Note: The below comands are not needed if the execurted through Docker, the Dockerfile as the necessary commands since cuda needs to be compiled in advance.
