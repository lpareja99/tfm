...
9. Cvat output organization:
`python initial_mask2former/scripts/save_cvat_output.py --cvat-dir ./data/laura_tfm_dry_annotated/test_annotation_output --work-dir data/laura_tfm_sun_22_dry`
