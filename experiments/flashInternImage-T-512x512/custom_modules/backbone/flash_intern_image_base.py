...
from mmengine.runner.checkpoint import load_checkpoint as _load_checkpoint
...
class FlashInternImage(BaseModule):
    ...
    def forward(self, x):
        # For segmentation, bypass the classification head 
        # and return the 4 multi-scale 4D feature maps!
