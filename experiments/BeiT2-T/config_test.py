# ===========================================================================
# Test/inference config (§4.2 adverse weather) for BEiT v2 base.
# Inherits the EXACT backbone/neck/decode head from config.py (so it matches the
# trained checkpoint) and only repoints the data to the weather dataset. Keeps
# BEiT's own test_pipeline (fixed 512x512 Resize + Pad size_divisor=32). No custom
# CUDA op -> runs on road_defect_base. run_weather.sh overrides test_dataloader.
# ===========================================================================
_base_ = ['./config.py']
