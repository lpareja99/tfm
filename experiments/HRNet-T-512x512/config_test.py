# ===========================================================================
# Test/inference config (§4.2 adverse weather) for HRNet-W32.
# Inherits the EXACT backbone/decode head from config.py (so it matches the
# trained checkpoint) and only repoints the data to the weather dataset. HRNet
# has no custom CUDA op -> runs on road_defect_base (CPU or GPU). run_weather.sh
# overrides test_dataloader per condition.
# ===========================================================================
_base_ = ['./config.py']
