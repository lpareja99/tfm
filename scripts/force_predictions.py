...
plt.title('Confusion Matrix: Swin-T (Recall Normalized)')
plt.ylabel('Actual Class')
plt.xlabel('Predicted Class')

if not os.path.exists('output'): os.makedirs('output')
plt.savefig('output/confusion_matrix_swin_t.png', bbox_inches='tight')
print("--- FINISHED! Your matrix is at: output/confusion_matrix_swin_t.png ---")